...
if(!message.member.voice.channel) return message.channel.send({embed: {color: AloneHata, description: ` Kuyruğu görüntüleyebilmek için bir ses kanalında olmanız gerekmektedir!` }})
...
message.channel.send({embed: {color: AloneDogru, title: `StaR_LorD's BOT |  Müzik Kuyruğu`, description: `${q}`}})
}
