...
exports.run = async (client, message, args, tools) => {
  ...
  if (!veri) {
    const embed = new Discord.MessageEmbed()
      ...
      .setColor("#ff0000")
.setThumbnail(`https://cdn.discordapp.com/attachments/761294300767846413/761832304552968212/ea3d461184a4470f1f2e4f4896a09a8b.png`)
...
.setThumbnail(`https://cdn.discordapp.com/attachments/761294300767846413/761832304552968212/ea3d461184a4470f1f2e4f4896a09a8b.png`)
  ...
  if (!message.member.roles.cache.has(veri)) {
    const embed = new Discord.MessageEmbed()
      ...
      .addField(`Total Davet:`, sayı2, true)
      .setColor("#ff0000")
.setThumbnail(`hhttps://cdn.discordapp.com/attachments/761294300767846413/761832304552968212/ea3d461184a4470f1f2e4f4896a09a8b.png`)
