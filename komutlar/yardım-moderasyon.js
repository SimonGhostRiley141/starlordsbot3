...
.setColor('#ff0000') 
.setAuthor(`StaR_LorD'S BOT Moderasyon Komutları`, client.user.avatarURL())
...
.addField(`__Soft Ban__`,` \`${prefix}softban\` Sunucunuzda Belirtiğiniz Kişiyi Yasaklar`,true)
.addField(`__Force Ban__`,` \`${prefix}forceban\` Sunucunuzda Olmayan Kişinin Yasaklanmasını Sağlar`,true)
...
.addField(`__Yasaklı Tag__`,` \`${prefix}yasaklıtag\` Sunucuza Belirli Taga Sahip Üyeler Giremez`,true)
