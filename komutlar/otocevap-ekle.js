...
if (!message.member.hasPermission('MANAGE_GUILD')) return message.channel.send(embeddd)
 ...
 if(args[0] == 'yardım' || args[0] == 'bilgi') return message.channel.send('Botun var olan bir komudunu ekleyemezsin.')                   
  let gonderileceksey;
